...
param VFT[FT] := <1,1> 3, <1,2> 2, <1,3> 5, <2,1> 3, <2,2> 2, <3,1> 3, <3,2> 2, <4,4> 4 default 0;  #para cada fábrica de origem cada tipo de veículo a quantidade disponível
...
param I0[F*P] := <5,1> 0, <1,1> 0, <3,1> 0, <5,2> 0, <1,2> 0, <3,2> 0, <5,3> 0, <1,3> 0, <4,3> 0, <5,4> 0, <4,4> 0, <5,5> 0, <2,5> 0, <5,6> 0, <4,6> 0 default 0; #estoque inicial em cada fábrica f de cada produto p
